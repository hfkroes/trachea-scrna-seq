...
```{r echo=TRUE, message=FALSE, warning=FALSE}
mapping <- c("0" = "Fb", "1" = "Fb", "2" = "Fb", "3" = "Fb", "4" = "Fb", "5" = "Fb", "6" = "Fb", "7" = "MΦ", "8" = "Fb", "9" = "Neut", "10" = "Pchon", "11" = "Fb", "12" = "Fb", "13" = "Pchon", "14" = "MΦ", "15" = "Epi", "16" = "MΦ", "17" = "Pchon", "18" = "MFb", "19" = "Lym", "20" = "Lym", "21" = "SMC", "22" = "MΦ", "23" = "MΦ", "24" = "Fb", "25" = "NC", "26" = "Lym", "27" = "Pchon", "28" = "Epi", "29" = "Pchon", "30" = "Epi", "31" = "EC", "32" = "EC", "33" = "Pchon", "34" = "LEC", "35" = "BC", "36" = "SMC", "37" = "Epi", "38" = "Epi", "39" = "EC")
...
epi_data <- subset(aggregated_data, subset = cell_type == "Epi" & vc < -5) %>%
  FindNeighbors(reduction = "pca", dims = 1:epi_data$pcs) %>%
  FindClusters()

DimPlot(epi_data, reduction = "umap", label = TRUE, raster = FALSE) + NoLegend()

epi_data <- PrepSCTFindMarkers(epi_data)
FindAndSaveMarkers(epi_data, "data/Epithelial/markers/integrated_markers.xlsx")
```
...
epi_data <- cluster_cells(epi_data, resolution = 1e-3)
